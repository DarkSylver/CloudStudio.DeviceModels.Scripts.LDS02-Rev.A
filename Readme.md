...
# Parsing + Configuration Script – LDS02 - Rev. A

This **Parsing + Configuration** script is designed for the **LDS02** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LDS02 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LDS02** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
