...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Door open status", endpointType.iasSensor);
    var total = endpoints.addEndpoint("3", "Total open door events", endpointType.genericSensor);
    total.variableTypeId = 1286;
    var last = endpoints.addEndpoint("4", "Last door open duration", endpointType.genericSensor);
    last.variableTypeId = 1291;
    endpoints.addEndpoint("5", "Alarm", endpointType.iasSensor);
